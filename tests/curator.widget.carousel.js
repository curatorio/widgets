...
(function (root, factory) {
    if(typeof define === "function" && define.amd) {
        ...
        define(["jquery",'slick'], function(jquery){
            return (root.Curator = factory(root, jquery));
        });
    } else if(typeof module === "object" && module.exports) {
        // CommonJS
        module.exports = (root.Curator = factory(root, require("jquery")));
    } else {
        // Plain old browser
        root.Curator = factory(root, root.jQuery);
    }
}(this, function(global, $, slick) {
    ...
    var Curator = {
        ...
        log:function (s) {
            if (global.console && Curator.debug) {
    ...
    $.extend(Curator.Popup.prototype, {
        ...
        init: function (post, feed) {
            ...
            this.underlay = $('#popup-underlay');
            this.$el = $('.popup');
            this.wrapper = $('#popup-wrapper');

            $('#popup-underlay, .popup .close').click(function (e) {
                e.preventDefault();
                that.hide();
            });
        ...
        show: function () {
            ...
            if (mediaUrl) {
                ...
                module.loadMainImage(mediaUrl, $imageWrapper, ['main-image']);
            }
        ...
        loadMainImage: function (source, $wrapper, classes, removeWrapperClass) {
            ...
            for (var i in classes) {
                if (classes.hasOwnProperty(i)) {
                    $(img).addClass(classes[i]); //console.log(classes[i]);
                }
            }
    ...
    $.extend(Curator.Post.prototype,{
        ...
        init:function (postJson) {
            ...
            this.el.find('.hitarea').click($.proxy(this.onPostClick,this));
        },
...
<div class="crt-post-c">\
    ...
    $.extend(Client.prototype,{
        ...
        init: function (options) {
            ...
            this.options = $.extend({},clientDefaults,options);
            ...
            if (!this.feed.checkPowered(this.$container)){
                ...
                this.feed.loadPosts($.proxy(this.onLoadPosts, this),$.proxy(this.onLoadPostsFail, this));
                ...
                that.$feed.slick(this.options.slick).on('afterChange', function(event, slick, currentSlide) {
                    ...
                    if (!that.allLoaded) {
                        ...
                        if (currentSlide >= that.totalPostsLoaded - 4) {
                            that.feed.loadMorePosts($.proxy(that.onLoadPosts, that), $.proxy(that.onLoadPostsFail, that));
                        }
                    }
                });
            }
